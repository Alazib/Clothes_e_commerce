...
//and then hits Saga. Once Saga performs, the flow MIGHT return again to the middleware, pass again through reducers and again to Saga...
// Another difference is while Thunk dispatch functions, Saga dispatch plain objects (as normal Redux does)
